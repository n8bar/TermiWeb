...
- The rendered terminal should still scale to use the available width around the chosen shared column count and let the visible row count change with height.

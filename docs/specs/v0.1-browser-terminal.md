...
- Valid shared-password browser sessions should survive a normal server restart until they expire or are revoked.
...
- The shared-password gate is part of the access model, but it is not the whole WAN-hardening story by itself.

...
- Snapshot-driven terminal rebuilds should force a local xterm repaint and request a same-size PTY redraw so interactive CLI apps can repaint after attach or recovery instead of depending on stale screen state.

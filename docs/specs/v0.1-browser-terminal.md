...
- Font sizing should also try to fit the shared row count into the device's visible terminal height when possible, without letting local viewport changes redefine the shared terminal geometry.

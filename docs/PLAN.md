...
Continue `M5` release polish with `Finding 5` in [FINDINGS.md](FINDINGS.md): interactive CLI rendering drift and ghost text, while dogfooding the clarified width-fit behavior from [the focused spec](specs/v0.1-per-instance-column-width.md).

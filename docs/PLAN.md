...
Continue [M10 0.1.2 Select fix and titles](worklists/m10-0.1.2-select-fix-and-titles.md): items `1`, `2`, and `4` are complete and [#2](https://github.com/n8bar/TermiWeb/issues/2), [#3](https://github.com/n8bar/TermiWeb/issues/3), [#5](https://github.com/n8bar/TermiWeb/issues/5), and [#7](https://github.com/n8bar/TermiWeb/issues/7) are closed. [The terminal-bell spec](specs/terminal-bell.md) is approved and implemented (item `5`), awaiting the manual verification pass before [#6](https://github.com/n8bar/TermiWeb/issues/6) closes. [The Windows-installer spec](specs/windows-installer.md) is approved and installer work (item `3`) is underway: the `SYSTEM` auto-start registration is written and awaits its live test, then ProgramData layout, the Inno Setup script, release assembly, and the VM verification follow.

...
Run real workstation/device validation against the live app, especially the width-fitted 80-column terminal, the now-elastic row count, the 4:3 stage behavior on phones, and the larger three-row control tray.

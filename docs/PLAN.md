...
Continue [M10 0.1.2 Select fix and titles](worklists/m10-0.1.2-select-fix-and-titles.md): items `1`, `2`, and `4` are complete and [#2](https://github.com/n8bar/TermiWeb/issues/2), [#3](https://github.com/n8bar/TermiWeb/issues/3), [#5](https://github.com/n8bar/TermiWeb/issues/5), and [#7](https://github.com/n8bar/TermiWeb/issues/7) are closed. Next is the maintainer sign-off on [the Windows-installer spec](specs/windows-installer.md), which gates installer work (item `3`); the bell spec (item `5`) can be drafted in parallel. User review of [the Windows-installer spec](specs/windows-installer.md) is the standing gate before installer implementation begins.
